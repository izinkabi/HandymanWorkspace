...
namespace Handymen_UI_Consumer.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private Handymen_UI_ConsumerUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<Handymen_UI_ConsumerUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Handymen_UI_ConsumerUser)}'. " +
                    $"Ensure that '{nameof(Handymen_UI_ConsumerUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<Handymen_UI_ConsumerUser> GetEmailStore()
        {
